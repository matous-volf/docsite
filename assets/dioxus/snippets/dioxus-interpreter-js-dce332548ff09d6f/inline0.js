...
function truthy(val) {
  return val === "true" || val === true;
    ...
    let u8buf,u8bufp;let s = "";let lsp,sp,sl; let c = new TextDecoder();let u32buf,u32bufp;let u16buf,u16bufp;const evt = [];
            ...
            let field,ns,len,event_name,bubbles,value,ptr,id;
